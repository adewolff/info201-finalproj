...
shinyServer(function(input, output) {
  ...
  reactiveDf <- reactive({
    ...
    vector_of_index <- c("Institution Name", "City", "No_of_Undergrads",
                         "UG_men", "UG_women", "Cost for UG",
                         "Average_SAT_Score")

    vector_uni_1 <- c(uni_1_info$Institution, uni_1_info$City,
    ...
    vector_uni_2 <- c(uni_2_info$Institution, uni_2_info$City,
